      ...
      <section className="py-20 bg-[#121212] text-white">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-bold">Ready to Transform Your Retail Space?</h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Experience the future of retail design with SR Lumex. Schedule a consultation with our experts to discover
              the perfect smart glass solution for your store.
            </p>
